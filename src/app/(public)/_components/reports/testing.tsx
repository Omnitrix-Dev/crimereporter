    ...
    <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <button
          ...
          className={`rounded-2xl border-2 p-6 transition-all duration-200 ${
            formData.incidentType === "EMERGENCY"
              ...
              : "border-zinc-800 bg-zinc-900/50 hover:border-red-500/50 hover:bg-red-500/10"
          }`}
        >
        ...
        <button
          ...
          className={`rounded-2xl border-2 p-6 transition-all duration-200 ${
            formData.incidentType === "NON_EMERGENCY"
              ...
              : "border-zinc-800 bg-zinc-900/50 hover:border-orange-500/50 hover:bg-orange-500/10"
          }`}
        >
          <div className="flex flex-col items-center space-y-2">
            <svg
      ...
      <div>
        ...
        <select
          ...
          className="w-full rounded-xl border border-zinc-800 bg-zinc-900/50 px-4 py-3.5 text-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-sky-500/40"
          required
        >
